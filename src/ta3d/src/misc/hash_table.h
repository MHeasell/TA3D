...
namespace TA3D
{
	...
	{
	public:
		typedef zuzuf::hashmap<K, T, TA3D::hash<K>> Dense;
		typedef zuzuf::hashmap<K, T, TA3D::hash<K>, 250> Sparse;
	};
	...
	{
	public:
		typedef zuzuf::hashset<K, TA3D::hash<K>> Dense;
		typedef zuzuf::hashset<K, TA3D::hash<K>, 250> Sparse;
	};
