...
namespace TA3D
{
	...
	void WATER::draw(float t, bool shaded)
	{
		...
		{
			glBegin(GL_QUADS);
			glTexCoord3f(-map_w / w + 0.5f, -map_h / w + 0.5f, 1.0f);
			...
			glTexCoord3f(-map_w / w + 0.5f, -map_h / w + 0.5f, 1.0f);
			glVertex4f(-map_w, 0.0f, -map_h, 1.0f);
			glTexCoord3f(map_w / w + 0.5f, -map_h / w + 0.5f, 1.0f);
			glVertex4f(map_w, 0.0f, -map_h, 1.0f);
			glTexCoord3f(map_w / w + 0.5f, -map_h / w + 0.5f, 0.0f);
			glVertex4f(map_w, 0.0f, -map_h, 0.0f);
			glTexCoord3f(-map_w / w + 0.5f, -map_h / w + 0.5f, 0.0f);
			glVertex4f(-map_w, 0.0f, -map_h, 0.0f);
