...
namespace TA3D
{
	...
	public:
		...
		void draw_HD(Camera* cam, byte player_mask, float dt, bool check_visibility = true, bool draw_uw = true);
		void draw(Camera* cam, byte player_mask, float dt, bool check_visibility = true, bool draw_uw = true);
