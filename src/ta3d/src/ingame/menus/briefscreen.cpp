	...
	namespace Menus
	{
		...
		void BriefScreen::doFinalize()
		{
			...
			if (pArea->get_object("brief.panning0"))
				pArea->get_object("brief.panning0")->Data = 0;
			if (pArea->get_object("brief.panning1"))
				pArea->get_object("brief.panning1")->Data = 0;
		...
		bool BriefScreen::doInitialize()
		{
			...
			if (planet_file == "green planet")
				planet_file = "anims\\greenbrief.gaf";
			else if (planet_file == "archipelago")
				planet_file = "anims\\archibrief.gaf";
			else if (planet_file == "desert")
				planet_file = "anims\\desertbrief.gaf";
			else if (planet_file == "lava")
				planet_file = "anims\\lavabrief.gaf";
			else if (planet_file == "wet desert")
				planet_file = "anims\\wdesertbrief.gaf";
			else if (planet_file == "metal")
				planet_file = "anims\\metalbrief.gaf";
			else if (planet_file == "red planet")
				planet_file = "anims\\marsbrief.gaf";
			else if (planet_file == "lunar")
				planet_file = "anims\\lunarbrief.gaf";
			else if (planet_file == "lush")
				planet_file = "anims\\lushbrief.gaf";
			else if (planet_file == "ice")
				planet_file = "anims\\icebrief.gaf";
			else if (planet_file == "slate")
				planet_file = "anims\\slatebrief.gaf";
			else if (planet_file == "water world")
				planet_file = "anims\\waterbrief.gaf";
			...
			for (int i = 0; i < planet_animation.size(); ++i)
			{
				if (ToLower(Substr(planet_animation[i].name, planet_animation[i].name.size() - 3, 3)) == "pan")
					pan_id = i;
				else if (ToLower(Substr(planet_animation[i].name, planet_animation[i].name.size() - 6, 6)) == "rotate")
					rotate_id = i;
			}
