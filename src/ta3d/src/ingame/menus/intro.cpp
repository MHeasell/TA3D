...
namespace TA3D
{
	namespace Menus
	{
		...
		void Intro::redrawTheScreen()
		{
			...
			glTexCoord2f(0.0f, (TA3D_INTRO_TOP - 60.0f) / float(SCREEN_H));
			glVertex2f(0.0f, TA3D_INTRO_TOP - 60.0f);
			glTexCoord2f(1.0f, (TA3D_INTRO_TOP - 60.0f) / float(SCREEN_H));
			glVertex2f(float(SCREEN_W), TA3D_INTRO_TOP - 60.0f);
			glTexCoord2f(1.0f, TA3D_INTRO_TOP / float(SCREEN_H));
			glVertex2f(float(SCREEN_W), TA3D_INTRO_TOP);
			glTexCoord2f(0.0f, TA3D_INTRO_TOP / float(SCREEN_H));
			glVertex2f(0.0f, TA3D_INTRO_TOP);
			...
			glVertex2f(float(SCREEN_W), TA3D_INTRO_TOP);
			glColor4ub(0xFF, 0xFF, 0xFF, 0xFF);
			glTexCoord2f(1.0f, (TA3D_INTRO_TOP + 2 * pCurrentFontHeight) / float(SCREEN_H));
			glVertex2f(float(SCREEN_W), TA3D_INTRO_TOP + 2 * pCurrentFontHeight);
			glTexCoord2f(0.0f, (TA3D_INTRO_TOP + 2 * pCurrentFontHeight) / float(SCREEN_H));
			glVertex2f(0.0f, TA3D_INTRO_TOP + 2 * pCurrentFontHeight);

			glTexCoord2f(0.0f, (TA3D_INTRO_BOTTOM - 2 * pCurrentFontHeight) / float(SCREEN_H));
			glVertex2f(0.0f, TA3D_INTRO_BOTTOM - 2 * pCurrentFontHeight);
			glTexCoord2f(1.0f, (TA3D_INTRO_BOTTOM - 2 * pCurrentFontHeight) / float(SCREEN_H));
			glVertex2f(float(SCREEN_W), TA3D_INTRO_BOTTOM - 2 * pCurrentFontHeight);
			glColor4ub(0xFF, 0xFF, 0xFF, 0);
			glTexCoord2f(1.0f, TA3D_INTRO_BOTTOM / float(SCREEN_H));
			glVertex2f(float(SCREEN_W), TA3D_INTRO_BOTTOM);
			glTexCoord2f(0.0f, TA3D_INTRO_BOTTOM / float(SCREEN_H));
			glVertex2f(0.0f, TA3D_INTRO_BOTTOM);

			glTexCoord2f(0.0f, TA3D_INTRO_BOTTOM / float(SCREEN_H));
			glVertex2f(0.0f, TA3D_INTRO_BOTTOM);
			glTexCoord2f(1.0f, TA3D_INTRO_BOTTOM / float(SCREEN_H));
			glVertex2f(float(SCREEN_W), TA3D_INTRO_BOTTOM);
			glTexCoord2f(1.0f, (TA3D_INTRO_BOTTOM + 60.0f) / float(SCREEN_H));
			glVertex2f(float(SCREEN_W), TA3D_INTRO_BOTTOM + 60.0f);
			glTexCoord2f(0.0f, (TA3D_INTRO_BOTTOM + 60.0f) / float(SCREEN_H));
			glVertex2f(0.0f, TA3D_INTRO_BOTTOM + 60.0f);
